      ...
      <div className="container mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label
                    htmlFor="name"
                    className="block text-sm font-medium text-mokotla-gray mb-1"
                  >
                    Full Name *
                  </label>
                  <input
          ...
          <div>
            ...
            <div className="bg-white p-1 rounded-lg shadow-md overflow-hidden h-80">
              {/* This would be a Google Maps embed - replace with actual embed code */}
              <div className="w-full h-full bg-gray-200 flex items-center justify-center">
                <p className="text-mokotla-gray font-medium">
